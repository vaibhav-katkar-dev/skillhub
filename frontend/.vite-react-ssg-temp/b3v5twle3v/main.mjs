...
import React4, { Component, useState, useRef, useEffect, useMemo, lazy, Suspense, StrictMode } from "react";
          ...
          /* @__PURE__ */ jsxs(
            "nav",
            {
              ...
              children: [
                ...
                LEGAL_LINKS.map(({ to, label }, i) => /* @__PURE__ */ jsxs(React4.Fragment, { children: [
                  /* @__PURE__ */ jsx(
                    Link,
                    {
                      to,
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center", children: [
      ...
      isAuthenticated ? /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-lg sm:text-xl text-slate-600 mb-8 sm:mb-10 max-w-2xl mx-auto font-medium", children: [
          "Welcome back, ",
          ((_a2 = user == null ? void 0 : user.name) == null ? void 0 : _a2.split(" ")[0]) || "Student",
    ...
    /* @__PURE__ */ jsxs("section", { style: { position: "relative", background: "linear-gradient(160deg,#eef2ff 0%, #f4f7ff 44%, #fafcff 100%)", minHeight: "92vh", display: "flex", alignItems: "center", justifyContent: "center", paddingTop: 100, paddingBottom: 80, overflow: "hidden" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "section-wrap", style: { position: "relative", zIndex: 10, textAlign: "center" }, children: [
        ...
        /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", justifyContent: "center", alignItems: "center", gap: "8px 22px" }, children: [
          ...
          React4.createElement(Icon, { size: 15, style: { color, flexShrink: 0 } }),
          text
        ] }, i)) })
      ] }),
...
const Login = () => {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setError(((_b2 = (_a2 = err.response) == null ? void 0 : _a2.data) == null ? void 0 : _b2.message) || "Failed to resend verification email");
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(((_b2 = (_a2 = err.response) == null ? void 0 : _a2.data) == null ? void 0 : _b2.message) || "Login Failed");
    } finally {
      setLoading(false);
    }
  };
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(((_b2 = (_a2 = err.response) == null ? void 0 : _a2.data) == null ? void 0 : _b2.message) || "Registration Failed");
    } finally {
      setLoading(false);
    }
  };
...
const Courses$1 = lazy(() => import("./assets/Courses-DsUJ5zov.js"));
const CourseDetail = lazy(() => import("./assets/CourseDetail-DwU9dHDo.js"));
const LessonView = lazy(() => import("./assets/LessonView-CiDJBxw3.js"));
const QuizView = lazy(() => import("./assets/QuizView-g8WiayFU.js"));
const Dashboard = lazy(() => import("./assets/Dashboard-W4ZGLe1N.js"));
const VerifyCert$1 = lazy(() => import("./assets/VerifyCert-D3JXI5AS.js"));
const Blog$1 = lazy(() => import("./assets/Blog-DmMRUFRU.js"));
const BlogPost$1 = lazy(() => import("./assets/BlogPost-DzVx_kUp.js"));
const ForgotPassword = lazy(() => import("./assets/ForgotPassword-BKKKlmRj.js"));
const ResetPassword = lazy(() => import("./assets/ResetPassword-BrwnH7kP.js"));
const PublicProfile = lazy(() => import("./assets/PublicProfile-BIIu7U3r.js"));
const AdminPanel = lazy(() => import("./assets/AdminPanel-BPho1sdg.js"));
const PrivacyPolicy$1 = lazy(() => import("./assets/PrivacyPolicy-BVmRR-VB.js"));
const TermsOfService$1 = lazy(() => import("./assets/TermsOfService-BTUL6qoC.js"));
const RefundPolicy$1 = lazy(() => import("./assets/RefundPolicy-C9NC4WzN.js"));
const CookiePolicy$1 = lazy(() => import("./assets/CookiePolicy-D6es_Rou.js"));
const Events$1 = lazy(() => import("./assets/Events-ZE2o7J1a.js"));
const HackathonDetail = lazy(() => import("./assets/HackathonDetail-CF2-wVPP.js"));
const JobSimulation = lazy(() => import("./assets/JobSimulation-BsvoVQbc.js"));
const HostHackathon$1 = lazy(() => import("./assets/HostHackathon-B5gPQE04.js"));
const CampusAmbassador$1 = lazy(() => import("./assets/CampusAmbassador-BAwLzXPZ.js"));
const FreeCourses$1 = lazy(() => import("./assets/FreeCourses-CKxv_XD2.js"));
const Certification$1 = lazy(() => import("./assets/Certification-l3DhURNx.js"));
const VerifyEmail = lazy(() => import("./assets/VerifyEmail-BNVhzhjy.js"));
function PageLoader() {
...
const Blog = lazy(() => import("./assets/Blog-DmMRUFRU.js"));
const BlogPost = lazy(() => import("./assets/BlogPost-DzVx_kUp.js"));
const Courses = lazy(() => import("./assets/Courses-DsUJ5zov.js"));
lazy(() => import("./assets/CourseDetail-DwU9dHDo.js"));
const Events = lazy(() => import("./assets/Events-ZE2o7J1a.js"));
const PrivacyPolicy = lazy(() => import("./assets/PrivacyPolicy-BVmRR-VB.js"));
const TermsOfService = lazy(() => import("./assets/TermsOfService-BTUL6qoC.js"));
const RefundPolicy = lazy(() => import("./assets/RefundPolicy-C9NC4WzN.js"));
const CookiePolicy = lazy(() => import("./assets/CookiePolicy-D6es_Rou.js"));
const FreeCourses = lazy(() => import("./assets/FreeCourses-CKxv_XD2.js"));
const CampusAmbassador = lazy(() => import("./assets/CampusAmbassador-BAwLzXPZ.js"));
const HostHackathon = lazy(() => import("./assets/HostHackathon-B5gPQE04.js"));
const Certification = lazy(() => import("./assets/Certification-l3DhURNx.js"));
const VerifyCert = lazy(() => import("./assets/VerifyCert-D3JXI5AS.js"));
const staticRoutes = [
