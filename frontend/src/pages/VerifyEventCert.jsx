        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="flex gap-2 mb-8">
            ...
            <button
              onClick={() => verify()}
              disabled={loading}
              className="px-6 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-sm transition-colors disabled:opacity-60"
            >
              {loading ? '…' : 'Verify'}
            </button>
          </div>
          ...
          <div className="mt-8 text-center">
            <Link to="/events" className="text-indigo-400 hover:text-indigo-300 text-sm">← Back to Events</Link>
          </div>
        </div>
      </section>
    </>
