...
export const AMBASSADOR_LEVELS = {
  ...
  platinum: {
    ...
    minPoints: 6000,
    maxPoints: Infinity,
    revenueSharePercent: 7, // Admin configurable (7-10%)
    claimable: true,
 ...
 * Used in Transparent Point Matrix v2.0.
 */
export const HACKATHON_TIERS = [
  { label: '₹1–₹99',    min: 1,    max: 99,   pct: 0.08, display: '8%',  color: 'text-amber-300' },
  { label: '₹100–₹299', min: 100,  max: 299,  pct: 0.10, display: '10%', color: 'text-amber-400' },
  { label: '₹300–₹499', min: 300,  max: 499,  pct: 0.12, display: '12%', color: 'text-amber-400' },
  { label: '₹500–₹999', min: 500,  max: 999,  pct: 0.15, display: '15%', color: 'text-amber-500' },
  { label: '₹1000+',    min: 1000, max: Infinity, pct: 0.18, display: '18%', color: 'text-yellow-400' },
];

/** 10% of any paid amount (courses, paid simulations, paid hackathons) */
